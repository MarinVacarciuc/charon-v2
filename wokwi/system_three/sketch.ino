/*
  ...
  Five-tier risk display with LCD feedback

  Source: Moodle-provided reference design, Unit 21 practical (Alarm System Three).
  Reproduced verbatim from the module's own code (originally built in Tinkercad).
*/
